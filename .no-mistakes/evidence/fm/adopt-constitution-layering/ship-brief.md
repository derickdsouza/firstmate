...
# Project memory
If `AGENTS.md` or `CLAUDE.md` already exists, or if this task produced durable project-intrinsic knowledge, run `/root/.no-mistakes/worktrees/7f0ec18181b6/01M1ESQWZ7A1FSEJ7A8JR3E4W7/bin/fm-ensure-agents-md.sh .` in the worktree.
...
If you touch a project `AGENTS.md` that lacks `## Maintaining this file`, add that short self-governance section from `/root/.no-mistakes/worktrees/7f0ec18181b6/01M1ESQWZ7A1FSEJ7A8JR3E4W7/bin/fm-ensure-agents-md.sh` in the same pass.
